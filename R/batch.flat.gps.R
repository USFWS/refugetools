...
#' @name batch.flat.gps
#' @title Reformats raw Telonics GPS collar data
#'
#' @description A function import and reformat raw Telonics GPS collar datato csv file into a tidy format (flat file) for analysis.
#'
#' @param iridium_csv.dir The directory location of the Iridium csv file to reformat.
#' @param save.file Whether to save the output file.
#' @param save.dir The directory location of the output file.
#' @param returnx Whether to return a dataframe of the output.
#' @param pattern The pattern of the input csv file.
#'
#' @return If returnx=TRUE, returns a dataframe of GPS collar data in tidy format (flat file). If save.file argument=TRUE, saves the outout as a gzip.
#'
#' @examples
#' \dontrun{
#' batch.flat.gps("./data/raw/iridium_csv", save.file=TRUE, save.dir="../data/derived/telonics", returnx=FALSE, pattern="Complete")}

flat.gps <- function(myfile, collprogsfile="../Data/RawData/GPSCollar/telonics/TelonicsCollarPrograms.csv"){
...
batch.flat.gps <- function(iridium_csv.dir,
                           save.file,
                           save.dir,
                           returnx,
                           pattern){
