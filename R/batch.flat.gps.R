...
#' @name batch.flat.gps
#' @title  Tidy up Telonics GPS collar data
#'
#' @description \code{batch.flat.gps()} imports and reformats raw Telonics GPS collar datato csv file into a tidy format (flat file) for analysis.
#'
...
#' @examples
#' \dontrun{
#' batch.flat.gps(iridium_csv.dir="./data/collardata",
